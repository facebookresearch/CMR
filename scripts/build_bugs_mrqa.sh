...
do
    ...
    python semanticdebugger/benchmark_gen/merge_json_file.py \
        --input_file_pattern "upstream_resources/qa_upstream_preds/tmp/${dataset_name}.predictions.#_of_${n_threads}.jsonl" \
        --output_file "upstream_resources/qa_upstream_preds/${dataset_name}.predictions.jsonl" \
