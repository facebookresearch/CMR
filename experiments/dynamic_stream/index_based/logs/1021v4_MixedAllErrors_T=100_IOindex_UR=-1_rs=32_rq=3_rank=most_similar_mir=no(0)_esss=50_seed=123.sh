...
prefix="1021v4_MixedAllErrors_T=${max_timecode}_IOindex_UR=${upstream_ratio}_rs=${replay_size}_rq=${replay_freq}_rank=${rank_method}_mir=${use_mir}(${mir_cand_size})_esss=50_seed=${seed}"
...
cp exp_results/dynamic_stream/index_based/run_bart_io_index.sh $tmp_script_copy
...
CUDA_VISIBLE_DEVICES=$gpu python semanticdebugger/debug_algs/run_lifelong_finetune.py \
    ...
    --save_all_ckpts 0 \
    --init_memory_cache_path "exp_results/data_streams/bart_io_index.init_memory.pkl" \
