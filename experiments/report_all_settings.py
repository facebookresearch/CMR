...
from semanticdebugger.notebooks.draw_utils import draw_grouped_bars
...
cl_methods = ['none_cl', 'simple_cl-l2w=0.0', 'online_ewc-250.0-0.9', 'er-32-3-l2w=0.0', 'mir-32/256-3-none-l2w=0.0']
cl_prefix = ["Frozen", "CFT", "OnEWC", "ER", "MIR"]
