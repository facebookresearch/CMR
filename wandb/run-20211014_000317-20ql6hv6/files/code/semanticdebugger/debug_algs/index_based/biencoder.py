...
def get_parser():
    ...
    parser.add_argument("--ds_dir_path",
                        default="exp_results/supervision_data/1013_mean_dm_simple/")
    ...
    parser.add_argument("--query_encoder_path", type=str,
                        default="exp_results/supervision_data/1013_mean_dm_simple.qry_encoder.pt")
    parser.add_argument("--memory_encoder_path", type=str,
                        default="exp_results/supervision_data/1013_mean_dm_simple.mem_encoder.pt")
    parser.add_argument("--memory_index_path", type=str,
                        default="exp_results/supervision_data/1013_mean_dm_simple.memory.index")
    parser.add_argument("--train_args_path", type=str,
                        default="exp_results/supervision_data/1013_mean_dm_simple.train_args.json")
...
if __name__ == '__main__':
    ...
    if biencoder_args.run_mode == "train":
        ...
        index_manager.save_memory_to_path("exp_results/data_streams/1013_mean_biencoder_init_memory.pkl")
