...
prefix="1019_MixedAllErrors_T=${max_timecode}_er_UR=${upstream_ratio}_rs=${replay_size}_rq=${replay_freq}_seed=${seed}"
...
tmp_script_copy=exp_results/dynamic_stream/memory_based/logs/${prefix}.sh
