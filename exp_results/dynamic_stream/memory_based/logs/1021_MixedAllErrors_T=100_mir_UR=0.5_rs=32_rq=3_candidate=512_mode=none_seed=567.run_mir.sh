...
prefix="1021_MixedAllErrors_T=${max_timecode}_mir_UR=${upstream_ratio}_rs=${replay_size}_rq=${replay_freq}_candidate=${candidate_size}_mode=${abalation_args}_seed=${seed}"
...
# exp_results/data_streams/mrqa.mixed.hidden_passes.jsonl \