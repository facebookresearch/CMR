...
prefix="1019_MixedAllErrors_T=${max_timecode}_index_M=U+I_rs=${replay_size}_rq=${replay_freq}_rank=${rank_method}_mir=${use_mir}(${mir_cand_size})_seed=${seed}"
...
CUDA_VISIBLE_DEVICES=$gpu python semanticdebugger/debug_algs/run_lifelong_finetune.py \
    ...
    --save_all_ckpts 0 \
    --init_memory_cache_path "exp_results/data_streams/bart_index.init_memory.pkl" \
