...
def draw_stacked_bars(df, y_scale=[0, 1], fig_title="", y_title="Y Title", x_key="timecode", y_key="em:Q", height=800, width=1150):
    x = alt.X(x_key, type="ordinal", title="Time Step", axis=alt.Axis(tickCount=10)) # axis=alt.Axis(tickCount=10)
    color=alt.Color('prefix:N')  
